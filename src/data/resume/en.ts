...
export const resumeEn: ResumeData = {
  ...
  skills: {
    ...
    categories: [
      ...
      { label: "AI", items: ["LLM/RAG", "Embeddings", "pgvector", "Mastra", "AI SDK"] },
    ],
  },
  languages: {
    title: "Languages",
  ...
  education: {
    title: "Education",
    items: [
      { degree: "Computer Science Engineer", school: "Polytech Montpellier", period: "2012 - 2015" },
      { degree: "Technical Degree in CS", school: "IUT Montpellier", period: "2010 - 2012" },
    ],
  },
  header: {
    ...
    items: [
      {
        ...
        description:
          "<strong>YC-backed startup (S21)</strong>, team of 3. CRM for recruitment agencies.<br />Versatile: frontend, backend, infrastructure, AI, user research.",
        achievements: [
          "Built semantic search used daily by recruiters (pgvector, RAG)",
          "AI notetaker replacing manual note-taking (LLM summaries, CRM auto-fill)",
          "Node.js/Fastify API from scratch, terraformed GCP infra, Datadog monitoring",
        ],
      ...
      },
      {
        ...
        description: "Leading job board in France, <strong>2M+ visitors/month</strong>.",
        achievements: [
      ...
      },
      {
        ...
        achievements: ["EDF customer portal, SNCF Réseau intranet, French Notaries website"],
