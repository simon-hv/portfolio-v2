...
export const resumeFr: ResumeData = {
  ...
  skills: {
    title: "Compétences",
    categories: [
      { label: "Frontend", items: ["React", "TypeScript", "Next.js", "Angular", "Redux"] },
      { label: "Backend", items: ["Node.js", "Express", "Fastify", "GraphQL", "PostgreSQL"] },
      { label: "Infra", items: ["AWS", "GCP", "Terraform", "Docker", "CI/CD"] },
      { label: "IA", items: ["LLM/RAG", "Embeddings", "pgvector", "Mastra", "AI SDK"] },
    ],
  },
  languages: {
    title: "Langues",
  ...
  education: {
    title: "Formation",
    items: [
      { degree: "Ingénieur Informatique", school: "Polytech Montpellier", period: "2012 - 2015" },
      { degree: "DUT Informatique", school: "IUT Montpellier", period: "2010 - 2012" },
    ],
  },
  header: {
    ...
    items: [
      {
        ...
        description:
          "Startup <strong>YC-backed (S21)</strong>, équipe de 3. CRM pour agences de recrutement.<br />Polyvalent : frontend, backend, infrastructure, IA, user research.",
        achievements: [
          "Implémentation d'une recherche sémantique utilisée quotidiennement (pgvector, RAG)",
          "Notetaker IA remplaçant la prise de notes manuelle (résumés LLM, auto-fill CRM)",
          "API Node.js/Fastify from scratch, infra GCP terraformée, monitoring Datadog",
        ],
        stack: "Next.js, React, TypeScript, Node.js, Fastify, PostgreSQL, pgvector",
      },
      {
        role: "Frontend Developer",
        company: "Welcome to the Jungle",
        period: "Juin 2023 - Mars 2025",
        description: "Job board leader en France, <strong>2M+ visiteurs/mois</strong>.",
        achievements: [
      ...
      },
      {
        ...
        description: "Consulting pour <strong>grands comptes français</strong>.",
        achievements: ["Portail client EDF, intranet SNCF Réseau, site Notaires de France"],
